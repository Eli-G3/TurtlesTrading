...
plt.plot(df.index, df['equity_curve_bh'], label=f'💼 Buy & Hold ({symbol.split(".")[0]})', color='gray', linestyle='--')
plt.title(f'Turtle Trading Strategy vs Buy & Hold ({symbol.split(".")[0]})')
plt.xlabel('Date')
